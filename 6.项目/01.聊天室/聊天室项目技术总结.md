...
**涉及知识点:**
- [[6.1 IO复用简介]] - IO复用的概念与必要性
- [[6.4 epoll模型]] - epoll的三个核心函数
...
2. **IO复用**
   - [[6.1 IO复用简介]] - 为什么需要IO复用
   - [[6.4 epoll模型]] - epoll三板斧
