...
tags:
  - 研一上学期
  - 复合机器人汇总
status: 历史归档副本（2026-07 两轮拍板原文；当前入口已迁移）
---

# MFMS 数据中台新版架构设计：分层、功能清单与拍板记录

> [!warning] 历史重复副本 · 不再作为当前入口
> 本文与“复合机器人汇总”中的 2026-07 架构篇原文相同，仅为历史留存。当前请从 [[MFMS新中台-资料索引与权威源]]、[[MFMS新中台-架构构造思路]] 和 [[MFMS新中台-待确定问题清单]] 进入；不要在本页继续追加新结论。
