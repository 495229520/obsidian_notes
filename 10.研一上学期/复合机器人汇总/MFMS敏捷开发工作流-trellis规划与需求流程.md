...
tags:
  - 研一上学期
  - 复合机器人汇总
status: 历史归档（早期 Trellis 组装方案；当前入口已迁移）
---

# MFMS 敏捷开发工作流：.trellis 规划与需求流程

> [!warning] 历史方案 · 不再作为当前入口
> 本文记录旧仓骨架评估与早期四项决策。Q-03 已改为新仓 `/Users/melene/project/mfms_Framework`，部分 gap 也已落地；当前组装方案见 [[MFMS新中台-Trellis工程结构方案]]，全部资料入口见 [[MFMS新中台-资料索引与权威源]]。不要在本页继续维护新中台计划。
