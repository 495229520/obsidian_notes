...
> 单个场景直达：[exec 家族](<../../图片/HTML/3.Linux/5. 系统进程控制函数/5.1-5.5 exec·退出·status·进程组动画.html#scene=exec>) · [退出出口](<../../图片/HTML/3.Linux/5. 系统进程控制函数/5.1-5.5 exec·退出·status·进程组动画.html#scene=exit>) · [stdio 缓冲区](<../../图片/HTML/3.Linux/5. 系统进程控制函数/5.1-5.5 exec·退出·status·进程组动画.html#scene=buffer>)
