...
> [▶ 在浏览器中打开动画](<../13. IO复用/13.2.1 select与epoll对比动画.html>)　·　更多见 [[网络编程·动画合集]]
> 也可直达单个场景：[select 工作流](<../13. IO复用/13.2.1 select与epoll对比动画.html#scene=select>) · [epoll 工作流](<../13. IO复用/13.2.1 select与epoll对比动画.html#scene=epoll>) · [对照总结](<../13. IO复用/13.2.1 select与epoll对比动画.html#scene=compare>)
