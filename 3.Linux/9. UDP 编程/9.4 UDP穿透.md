...
> [▶ 在浏览器中打开动画](<../9. UDP 编程/9.4.1 UDP穿透动画.html>)　·　更多见 [[网络编程·动画合集]]
> 也可直达单个场景：[NAT 映射与过滤](<../9. UDP 编程/9.4.1 UDP穿透动画.html#scene=nat>) · [同 socket 复用](<../9. UDP 编程/9.4.1 UDP穿透动画.html#scene=sock>) · [双端 PUNCH](<../9. UDP 编程/9.4.1 UDP穿透动画.html#scene=punch>) · [保活](<../9. UDP 编程/9.4.1 UDP穿透动画.html#scene=keep>) · [STUN·ICE·TURN](<../9. UDP 编程/9.4.1 UDP穿透动画.html#scene=ice>)
