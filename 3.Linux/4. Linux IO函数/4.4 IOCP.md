...
> [▶ 在浏览器中打开动画](<../4. Linux IO函数/4.4.1 IOCP动画.html>)　·　更多见 [[网络编程·动画合集]]
> 也可直达单个场景：[请求投递](<../4. Linux IO函数/4.4.1 IOCP动画.html#scene=post>) · [两层上下文](<../4. Linux IO函数/4.4.1 IOCP动画.html#scene=ctx>) · [worker 取包](<../4. Linux IO函数/4.4.1 IOCP动画.html#scene=loop>) · [失败完成](<../4. Linux IO函数/4.4.1 IOCP动画.html#scene=fail>)
