...
> [▶ 在浏览器中打开动画](<../8. TCP 编程/8.9.1 TCP粘包与拆包动画.html>)　·　更多见 [[网络编程·动画合集]]
> 也可直达单个场景：[粘包与拆包](<../8. TCP 编程/8.9.1 TCP粘包与拆包动画.html#scene=stick>) · [边界方案](<../8. TCP 编程/8.9.1 TCP粘包与拆包动画.html#scene=scheme>) · [解析状态机](<../8. TCP 编程/8.9.1 TCP粘包与拆包动画.html#scene=parser>)
