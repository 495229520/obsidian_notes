...
> [▶ 在浏览器中打开动画](<file:///Users/melene/Documents/C++/obsidian_notes-main/3.Linux/8. TCP 编程/8.9.1 TCP粘包与拆包动画.html>)　·　更多见 [[网络编程·动画合集]]
> 也可直达单个场景：[粘包与拆包](<file:///Users/melene/Documents/C++/obsidian_notes-main/3.Linux/8. TCP 编程/8.9.1 TCP粘包与拆包动画.html#scene=stick>) · [边界方案](<file:///Users/melene/Documents/C++/obsidian_notes-main/3.Linux/8. TCP 编程/8.9.1 TCP粘包与拆包动画.html#scene=scheme>) · [解析状态机](<file:///Users/melene/Documents/C++/obsidian_notes-main/3.Linux/8. TCP 编程/8.9.1 TCP粘包与拆包动画.html#scene=parser>)
...
7. **协议字段要有上限和版本**：防止恶意长度和后续不兼容
8. **结构体不要直接裸发**：要处理字节序、对齐、版本和跨平台差异
