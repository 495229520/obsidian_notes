...
这符合 [[3.Linux/7. 网络编程/06. I-O 模型与复用/13.6 Reactor模式与EventLoop|Reactor 与 EventLoop]] 的“一个 loop 管一组 IO 状态”思路，也最容易证明不会重复消费 CQE或重复归还。
...
- [[3.Linux/7. 网络编程/06. I-O 模型与复用/13.6 Reactor模式与EventLoop|Reactor模式与 EventLoop]] - 单 owner 事件循环与跨线程回收
